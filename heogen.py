...
╚═╝  ╚═╝╚══════╝ ╚═════╝      ╚═════╝ ╚══════╝╚═╝  ╚═══╝                      
                                                                          """)
    print(f'''{Fore.LIGHTWHITE_EX}                    [ Made by {Fore.YELLOW}Heo {Fore.LIGHTWHITE_EX}]
  {Fore.LIGHTWHITE_EX}
  ''')
    print("""
    [1] Generators
...
def amazon():
    ...
    ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝     ╚═════╝ ╚══════╝╚═╝  ╚═══╝                                                                   
    """)
    print(f"""{Fore.LIGHTWHITE_EX}     [ Made by {Fore.YELLOW}Heo {Fore.LIGHTWHITE_EX}]{Fore.GREEN} Heo Gen
  {Fore.LIGHTWHITE_EX}
  """)
...
def netflix():
    ...
    ╚═╝  ╚═══╝╚══════╝   ╚═╝   ╚═╝     ╚══════╝╚═╝╚═╝  ╚═╝     ╚═════╝ ╚══════╝╚═╝  ╚═══╝                                                                                                                                            
    """)
    print(f"""{Fore.LIGHTWHITE_EX}     [ Made by {Fore.YELLOW}drk#1337 {Fore.LIGHTWHITE_EX}]{Fore.GREEN} Heo Gen
  {Fore.LIGHTWHITE_EX}
  """)
    print(f"{Fore.YELLOW}[*]{Fore.LIGHTWHITE_EX} Setting Up...")
    time.sleep(1)
...
def googleplay():
    ...
    ╚██████╔╝╚██████╔╝╚██████╔╝╚██████╔╝███████╗███████╗    ██║         ╚██████╔╝███████╗██║ ╚████║                                                                                                                                                                                                                                                                                                                                                                                                                                       
    """)
    print(f"""{Fore.LIGHTWHITE_EX}     [ Made by {Fore.YELLOW}Heo {Fore.LIGHTWHITE_EX}]{Fore.GREEN} Heo
  {Fore.LIGHTWHITE_EX}
  """)
    print(f"{Fore.YELLOW}[*]{Fore.LIGHTWHITE_EX} Setting Up...")
    time.sleep(1)
